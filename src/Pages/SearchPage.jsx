...
const prices = [
  {
    name: 'Price 100 to Price 2000',
    value: '100-2000',
  },
  {
    name: 'Price 2000 to Price 10000',
    value: '2000-10000',
  },
  {
    name: 'Price 10000 to Price 50000',
    value: '10000-50000',
  },
];
    ...
    const fetchData = async () => {
      try {
        const { data } = await axios.get(
          API_URL + `/products/search?page=${page}&query=${query}&category=${category}&price=${price}&rating=${rating}&order=${order}`
        );
